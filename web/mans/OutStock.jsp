		...
		<div class="col-md-12 column">
			<div class="row clearfix">
				...
				<div class="col-md-4 column">
					...
					<form role="form" action="${pageContext.request.contextPath}/MShowOutStockServlet" method="post">
					...
					<table class="table">
						...
						<c:forEach items="${user}"  var="obj">
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath}/MDelOutStockServlet?id=${obj.id}&idt=${obj.idt}&num=${obj.num}">删除</a>|
